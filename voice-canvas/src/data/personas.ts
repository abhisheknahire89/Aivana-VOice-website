...
export const PERSONAS: Persona[] = [
    {
        ...
        bestFor: ['Patient queries • 24/7 resolution', 'Insurance FAQs • 100% accurate', 'Multilingual support • 10 languages', 'Billing support • Zero wait time'],
        features: [
    ...
    },
    {
        ...
        bestFor: ['Lead qualification • 30% more conversions', 'Treatment explanation • Clear & concise', 'Follow-ups • 100% automated', 'Health camps • Higher turnout'],
        features: [
    ...
    },
    {
        ...
        bestFor: ['Symptom triage • 2 min avg intake', 'Patient routing • 94% accuracy', 'OPD booking • Instant confirmation', 'EHR integration • Deep sync'],
        features: [
